...
Safari connection might not work with VPN because of the system-wide proxy setup. **System-Wide proxy does not work along with VPN on macOS.** Please turn off the VPN to continue debugging with Requestly
