...
> You can check out the demo [here](https://www.youtube.com/watch?v=lOt1kGKTq-w).
...
See the [Map Local](/browser-extension/chrome/features/map-local) tool which helps to serve requests from your local file.
