...
<img src="/img/docs/http-modifications/testing-rule.png" alt="Testing Rule" width="50%"/>
...
<details>
  ...
  <div>
    Use <a href="/guides/know-if-rule-executed-on-page">this</a> guide to check if the rule executed or not
  </div>
</details>
<details>
...
<details>
  ...
  <div>
    Right now this is not possible in Browser Extension. But you can use our <a href="../../../desktop-app/mac/features/map-local">desktop app</a> to redirect to a local file (Map Local)
  </div>
</details>
